package com.yxx.common.utils.poi;
...
import com.yxx.common.utils.DictUtils;
import com.yxx.common.utils.StringUtils;
import com.yxx.common.utils.file.FileTypeUtils;
import com.yxx.common.utils.file.FileUtils;
import com.yxx.common.utils.file.ImageUtils;
...
public class ExcelUtil<T>
{
    ...
    public void createTitle()
    {
        if (StringUtils.isNotEmpty(title))
        {
            ...
            if (isSubList())
            {
                titleLastCol = titleLastCol + subFieldsMap.size() - 1;
            }
        ...
        if (rows > 0)
        {
            ...
            for (int i = titleNum + 1; i <= rows; i++)
            {
                ...
                for (Map.Entry<Integer, Object[]> entry : fieldsMap.entrySet())
                {
                    ...
                    // 如果不存在实例则新建.
                    entity = (entity == null ? ReflectUtils.newInstance(clazz) : entity);
                    // 从map中得到对应列的field.
