package com.yxx.quartz.controller;
...
import com.yxx.common.exception.job.TaskException;
import com.yxx.common.utils.StringUtils;
import com.yxx.common.utils.poi.ExcelUtil;
import com.yxx.quartz.domain.SysJob;
import com.yxx.quartz.service.ISysJobService;
import com.yxx.quartz.util.CronUtils;
import com.yxx.quartz.util.ScheduleUtils;
...
public class SysJobController extends BaseController
{
    ...
    public AjaxResult add(@RequestBody SysJob job) throws SchedulerException, TaskException
    {
        ...
        job.setCreateById(getUserId());
        job.setCreateByName(getUsername());
