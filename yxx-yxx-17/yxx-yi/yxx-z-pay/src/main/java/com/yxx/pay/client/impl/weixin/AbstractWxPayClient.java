...
import static com.yxx.pay.client.impl.weixin.WxPayClientConfig.API_VERSION_V2;
import static com.yxx.pay.client.impl.weixin.WxPayClientConfig.API_VERSION_V3;
    ...
    protected PayOrderRespDTO doUnifiedOrder(PayOrderUnifiedReqDTO reqDTO) throws Exception {
        try {
            switch (config.getApiVersion()) {
                ...
                case API_VERSION_V3:
                    // 参考 https://github.com/binarywang/WxJava/issues/1557
...
//                .transferSceneReportInfos(JacksonUtils.parseArray(reqDTO.getChannelExtras().get("sceneReportInfos"),
