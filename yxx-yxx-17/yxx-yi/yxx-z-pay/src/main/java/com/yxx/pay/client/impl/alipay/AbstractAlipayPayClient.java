package com.yxx.pay.client.impl.alipay;
...
import static com.yxx.pay.client.impl.alipay.AlipayPayClientConfig.MODE_CERTIFICATE;
import static com.yxx.pay.client.impl.alipay.AlipayPayClientConfig.MODE_PUBLIC_KEY;
...
public abstract class AbstractAlipayPayClient extends AbstractPayClient<AlipayPayClientConfig> {
    ...
    public PayRefundRespDTO doParseRefundNotify(Map<String, String> params, String body, Map<String, String> headers) {
        ...
        // 所以，这里在解析时，即使是退款导致的订单状态同步，也忽略不做为“退款同步”，而是订单的回调。
...
//            model.setBusinessParams(JacksonUtils.toJsonString(reqDTO.getChannelExtras()));
//        }
//        // ② 个性化的参数
