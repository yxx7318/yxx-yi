...
let calendar = {
  ...
  /**
      ...
      * @param m  lunar month
      * @param d  lunar day
      * @param isLeapMonthParam  lunar month is leap or not.[如果是农历闰月第四个参数赋值true即可]
      * @return JSON object
      * @eg:console.log(calendar.lunar2solar(1987,9,10));
      */
  lunar2solar: function (y, m, d, isLeapMonthParam) { // 参数区间1900.1.31~2100.12.1
    let isLeapMonth = !!isLeapMonthParam
    let leapOffset = 0
